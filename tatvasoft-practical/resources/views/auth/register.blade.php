    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('save_register') }}" enctype="multipart/form-data" id="registerForm">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end">Date of Birth</label>
                            <div class="col-md-6">
                                <input id="dob" type="test" class="form-control" name="dob" required autocomplete="new-password">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input class="form-control @error('dob') is-invalid @enderror" type="file" id="formFile" required name="image">
                        ...
                        <div class="row mb-3">
                            <label for="formFile" class="col-md-4 col-form-label text-md-end">Select Role</label>
                            <div class="col-md-6">
